...
//        if ( player1.getDrawingCacheBackgroundColor() == Color.BLUE  && player1.getAlpha() != 0) {
//            return player1.getText().toString().trim();
//        } else if (player2.getDrawingCacheBackgroundColor() == Color.BLUE && player2.getAlpha() != 0) {
//            return player2.getText().toString().trim();
//        } else if (player3.getDrawingCacheBackgroundColor() == Color.BLUE && player3.getAlpha() != 0) {
//            return  player3.getText().toString().trim();
//        } else if (player4.getDrawingCacheBackgroundColor() == Color.BLUE && player4.getAlpha() != 0) {
//            return player4.getText().toString().trim();
//        }
//        Toast.makeText(getApplicationContext(),"player1:"+player1.getBackground().getOpacity(),Toast.LENGTH_SHORT).show();
//        Toast.makeText(getApplicationContext(),"player2:"+player2.getBackground().getOpacity(),Toast.LENGTH_SHORT).show();
//        Toast.makeText(getApplicationContext(),"player3:"+player3.getBackground().getOpacity(),Toast.LENGTH_SHORT).show();
//        Toast.makeText(getApplicationContext(),"player4:"+player4.getBackground().getOpacity(),Toast.LENGTH_SHORT).show();
//
//        Toast.makeText(getApplicationContext(),"player4:"+player4.getBackground().getOpacity(),Toast.LENGTH_SHORT).show();
